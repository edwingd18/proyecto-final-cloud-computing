    ...
    fecha_fin: {
      ...
      validate: {
        validator: function (value) {
          ...
          const fechaInicio =
            this.fecha_inicio instanceof Date
              ? this.fecha_inicio
              : new Date(this.fecha_inicio);
          const fechaFin = value instanceof Date ? value : new Date(value);
...
mantenimientoSchema.methods.cambiarEstado = function (
  nuevoEstado,
  usuario = "Sistema"
) {
